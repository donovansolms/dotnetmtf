...
namespace NUIGroup
{
    namespace MultitouchFramework
    {
        ...
        {
            /// <summary>
            /// Grid class that responds to touch events
            /// </summary>
            public class TouchGrid : Grid
            {
                #region Properties
                /// <summary>
                /// Sets if the instance can be dragged
                /// </summary>
                ...
                /// <summary>
                /// Sets if the instance can be rotated
                /// </summary>
                ...
                /// <summary>
                /// Sets if the instance can be scaled
                /// </summary>
                ...
                public static readonly RoutedEvent fingerDownEvent = EventManager.RegisterRoutedEvent("fingerDown", RoutingStrategy.Bubble, typeof(fingerDownHandler), typeof(TouchGrid));
                public static readonly RoutedEvent fingerUpEvent = EventManager.RegisterRoutedEvent("fingerUp", RoutingStrategy.Bubble, typeof(fingerUpHandler), typeof(TouchGrid));
                public static readonly RoutedEvent fingerUpdateEvent = EventManager.RegisterRoutedEvent("fingerUpdate", RoutingStrategy.Bubble, typeof(fingerUpdateHandler), typeof(TouchGrid));
                ...
                public TouchGrid()
                {
                    try
                    {
                        TouchEngine.Instance.registerClass(typeof(TouchGrid));
                        _fingerList = new TouchList();
                        this.fingerDown += new fingerDownHandler(TouchGrid_fingerDown);
                        this.fingerUp += new fingerUpHandler(TouchGrid_fingerUp);
                        this.fingerUpdate += new fingerUpdateHandler(TouchGrid_fingerUpdate);
                    }
                    catch (Exception e)
                    {
                ...
                /// </summary>
                /// <param name="sender">The Touch element that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchGrid_fingerDown(object sender, TouchEventArgs e)
                {
                ...
                /// </summary>
                /// <param name="sender">The element that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchGrid_fingerUp(object sender, TouchEventArgs e)
                {
                ...
                /// <param name="sender">The element that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchGrid_fingerUpdate(object sender, TouchEventArgs e)
                {
