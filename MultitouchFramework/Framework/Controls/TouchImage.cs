...
namespace NUIGroup
{
    namespace MultitouchFramework
    {
        ...
        {
            /// <summary>
            /// Image class that responds to touch events
            /// </summary>
            public class TouchImage : Image
            {
                ...
                public static readonly RoutedEvent fingerDownEvent = EventManager.RegisterRoutedEvent("fingerDown", RoutingStrategy.Bubble, typeof(fingerDownHandler), typeof(TouchImage));
                public static readonly RoutedEvent fingerUpEvent = EventManager.RegisterRoutedEvent("fingerUp", RoutingStrategy.Bubble, typeof(fingerUpHandler), typeof(TouchImage));
                public static readonly RoutedEvent fingerUpdateEvent = EventManager.RegisterRoutedEvent("fingerUpdate", RoutingStrategy.Bubble, typeof(fingerUpdateHandler), typeof(TouchImage));
                ...
                public TouchImage()
                {
                    try
                    {
                        TouchEngine.Instance.registerClass(typeof(TouchImage));
                        _fingerList = new TouchList();
                        this.fingerDown += new fingerDownHandler(TouchImage_fingerDown);
                        this.fingerUp += new fingerUpHandler(TouchImage_fingerUp);
                        this.fingerUpdate += new fingerUpdateHandler(TouchImage_fingerUpdate);
                    }
                    catch(Exception e)
                    {
                ...
                /// </summary>
                /// <param name="sender">The image that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchImage_fingerDown( object sender, TouchEventArgs e )
                {
                ...
                /// <param name="sender">The image that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchImage_fingerUp( object sender, TouchEventArgs e )
                {
                ...
                /// <param name="sender">The image that sent the event</param>
                /// <param name="e">The Custom touch event arguments</param>
                void TouchImage_fingerUpdate( object sender, TouchEventArgs e )
                {
